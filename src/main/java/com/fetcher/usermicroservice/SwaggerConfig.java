package com.fetcher.usermicroservice;
...
public class SwaggerConfig {
    ...
    public static final ApiInfo DEFAULT = new ApiInfo("Api Documentation for Starwars",
            "This module is in charge of CRUD operations for users", "1.0", "urn:tos", DEFAULT_CONTACT,
    ...
    public Docket api() {
        return new Docket(DocumentationType.SWAGGER_2).apiInfo(DEFAULT).produces(DEFAULT_PRODUCES)
                .select()
                .apis(RequestHandlerSelectors.basePackage( "com.fetcher.usermicroservice.controllers" ) )
